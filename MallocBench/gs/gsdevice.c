...
void gs_deviceparams(gx_device *dev, gs_matrix *pmat, int *pwidth,
                     int *pheight) {
...
int trace_open_device(gx_device *dev) {
  ...
  if (gs_debug['v'])
    printf("[v]\topen_device(dev)"), trace_print_code(result);
  return result;
}
private
...
int trace_sync_output(gx_device *dev) {
  ...
  if (gs_debug['v'])
    printf("[v]\tsync_output(dev)"), trace_print_code(result);
  return result;
}
private
int trace_output_page(gx_device *dev) {
  ...
  if (gs_debug['v'])
    printf("[v]\toutput_page(dev)"), trace_print_code(result);
  return result;
}
private
int trace_close_device(gx_device *dev) {
  ...
  if (gs_debug['v'])
    printf("[v]\tclose_device(dev)"), trace_print_code(result);
  return result;
}
private
gx_color_index trace_map_rgb_color(gx_device *dev, ushort r, ushort g,
                                   ushort b) {
