...
int gp_file_name_is_absolute(
    char *fname, uint len) { /****** THIS NEEDS TO BE WRITTEN ******/
  return 0;
}
...
char *
gp_file_name_concat_string(char *prefix, uint plen, char *fname,
                           uint len) { /****** THIS NEEDS TO BE CHECKED ******/
  if (plen > 0)
