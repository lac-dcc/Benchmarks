...
gram.h. All guards are copied into the fguard file and all actions into faction,
...
void reader(void) {
  ...
  /* Read the declaration section.  Copy %{ ... %} groups to ftable and fdefines
     file. Also notice any %token, %left, etc. found there.  */
