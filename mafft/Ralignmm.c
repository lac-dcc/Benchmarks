...
//	float fpenalty = (float)penalty;
  ...
  if (outgap == 1) {
    ...
    for (i = 1; i < lgth1 + 1; i++) {
      ...
      //mada 			tmppenal = ( (1.0-gapf2[j-1])*(1.0-ogcp1g[i]+fgcp1g[i]) +
      ...
      //0.0*(1.0-0.0-0.0) ) * 0.5 * fpenalty; // mada 			tmppenal = 0.5 * fpenalty;
      //			tmppenal -= ( (1.0-0.0) * (1.0-diaf1[0]) + 0.0 )
      //* 0.5 * fpenalty; // 0. 			tmppenal -= ( (1.0-gapf2[j-1]) * ogcp1g[i] +
      //gapf2[j-1] ) * 0.5 * fpenalty; 			fprintf( stderr, "0,0<-%d,%d, tmppenal 1
      //= %f\n", i, 0, tmppenal );
      initverticalw[i] += tmppenal;

      //	Q		tmppenal = (
      //(1.0-gapz2[1])*(1.0-fgcp1g[i]+ogcp1g[i]-digf1[i]) ) * 0.5 * fpenalty; //
      //mada 			tmppenal = ( (1.0-gapf2[j])*(1.0-fgcp1g[i]+ogcp1g[i]) +
    ...
    for (j = 1; j < lgth2 + 1; j++) {
      ...
      //mada 			tmppenal = ( (1.0-gapf1[i-1])*(1.0-ogcp2g[j]+fgcp2g[j]) +
      ...
      //* 0.5 * fpenalty; // 0. 			tmppenal -= ( (1.0-gapf1[0]) * fgcp2g[j] +
      //gapf1[0] ) * 0.5 * fpenalty; 			fprintf( stderr, "0,0<-%d,%d, tmppenal 3 =
      //%f\n", 0, j, tmppenal );
      currentw[j] += tmppenal;

      //			tmppenal = (
      //(1.0-gapz1[1])*(1.0-fgcp2g[j]+ogcp2g[j]-digf2[j]) ) * 0.5 * fpenalty; //
      //mada 			tmppenal = ( (1.0-gapf1[i])*(1.0-fgcp2g[j]+ogcp2g[j]) +
...
//%d\n", lgth1, i );
    ...
    for (j = 1; j < lastj; j++) {
      ...
      *ijppt = 0;
      ...
      //// mada 			tmppenal = ( (1.0-gapf1[i])*(1.0-fgcp2g[j]) +
      //gapf1[i]*(1.0-digf2[j]-diaf2[j]) ) * 0.5 * fpenalty; // mada
      ...
      //0.5 * fpenalty; 			tmppenal -= ( (1.0-gapf1[i])*(1.0-diaf2[j]) + gapf1[i] )
      //* 0.5 * fpenalty; 			tmppenal -= ( (1.0-gapf1[i])*fgcp2g[j] + gapf1[i] ) *
      //0.5 * fpenalty; 			tmppenal = *fgcp2pt-fpenalty*0.5*gapf1[i]; 			tmppenal =
      //*fgcp2pt;
      if ((g = mi + tmppenal) > wm) {
      ...
      //= *ogcp2pt-fpenalty*0.5*(gapf2[j-1]+gapf1[i-1]); 			tmppenal = 0.5 *
      //fpenalty; 			tmppenal -= ( (1.0-gapf1[i-1])*(1.0-diaf2[j]) + gapf1[i-1] ) *
      //0.5 * fpenalty; 			tmppenal -= ( (1.0-gapf1[i-1])*ogcp2g[j] + gapf1[i-1] )
      //* 0.5 * fpenalty; 			tmppenal = *prept+*ogcp2pt;
      ...
      //( (1.0-gapf2[j])*(1.0-fgcp1g[i]) + gapf2[j]*(1.0-digf1[i]-diaf1[i]) ) *
      //0.5 * fpenalty; // mada 			tmppenal = 0.5 * fpenalty; 			tmppenal -= (
      //(1.0-gapf2[j])*(1.0-diaf1[i]) + gapf2[j] ) * 0.5 * fpenalty; 			tmppenal -=
      //( (1.0-gapf2[j])*fgcp1g[i] + gapf2[j] ) * 0.5 * fpenalty; 			tmppenal =
      //fgcp1va-fpenalty*0.5*gapf2[j]; 			tmppenal = fgcp1va;
      ...
      //= ( (1.0-gapf2[j-1])*(1.0-ogcp1g[i]) +
      //gapf2[j-1]*(1.0-digf1[i]-diaf1[i]) ) * 0.5 * fpenalty; // mada 			tmppenal
      //= ogcp1va-fpenalty*0.5*(gapf1[i-1]+gapf2[j-1]); 			tmppenal = 0.5 *
      //fpenalty; 			tmppenal -= ( (1.0-gapf2[j-1]) * (1.0-diaf1[i]) + gapf2[j-1] )
      //* 0.5 * fpenalty; 			tmppenal -= ( (1.0-gapf2[j-1]) * ogcp1g[i] +
      //gapf2[j-1] ) * 0.5 * fpenalty; 			tmppenal = 0.5 * fpenalty - (
      //(1.0-gapf2[j-1]) * (ogcp1g[i]) + gapf2[j-1] ) * ( 0.5 * fpenalty );
