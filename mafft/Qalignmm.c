...
//%d\n", lgth1, i );
    ...
    for (j = 1; j < lastj; j++) {
      ...
      //fpenalty * 0.5; 			if( g && i==j ) fprintf( stderr, "match penal1=%f,
      //%c-%c\n", g, seq1[0][i], seq2[0][j] );
      wm += g;
      ...
      //fpenalty * 0.5; 			if( g && i==j ) fprintf( stderr, "match penal2=%f,
      //%c-%c\n", g, seq1[0][i], seq2[0][j] );
      wm += g;
      ...
      //fpenalty * 0.5; 			if( g && i==j ) fprintf( stderr, "match penal3=%f,
      //%c-%c\n", g, seq1[0][i], seq2[0][j] );
      wm += g;
      ...
      //fpenalty * 0.5; 			if( g && i==j ) fprintf( stderr, "match penal4=%f,
      //%c-%c\n", g, seq1[0][i], seq2[0][j] );
      wm += g;
