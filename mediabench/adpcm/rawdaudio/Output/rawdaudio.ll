...
while.body:                                       ; preds = %while.cond
  %call = call i64 @"\01_read"(i32 0, i8* getelementptr inbounds ([500 x i8], [500 x i8]* @abuf, i32 0, i32 0), i64 500)
...
if.end.5:                                         ; preds = %if.end
  ...
  %call8 = call i64 @"\01_write"(i32 1, i8* bitcast ([1000 x i16]* @sbuf to i8*), i64 %conv7)
  br label %while.cond
...
declare void @adpcm_decoder(i8*, i16*, i32, %struct.adpcm_state*) #2
