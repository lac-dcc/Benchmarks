...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  call void (i32, i32, i32, i32, i32, i32, i32, %struct.g72x_state*, ...) bitcast (void (...)* @update to void (i32, i32, i32, i32, i32, i32, i32, %struct.g72x_state*, ...)*)(i32 5, i32 %conv45, i32 %conv48, i32 %conv51, i32 %conv52, i32 %conv53, i32 %conv54, %struct.g72x_state* %44)
...
entry:
  ...
  call void @llvm.lifetime.start(i64 2, i8* %4) #3
  %5 = bitcast i16* %dif to i8*
  call void @llvm.lifetime.start(i64 2, i8* %5) #3
  %6 = bitcast i16* %sr to i8*
  call void @llvm.lifetime.start(i64 2, i8* %6) #3
  %7 = bitcast i16* %dq to i8*
  call void @llvm.lifetime.start(i64 2, i8* %7) #3
  %8 = bitcast i16* %dqsez to i8*
  call void @llvm.lifetime.start(i64 2, i8* %8) #3
  %9 = load i32, i32* %i.addr, align 4, !tbaa !2
  %and = and i32 %9, 31
  store i32 %and, i32* %i.addr, align 4, !tbaa !2
  %10 = load %struct.g72x_state*, %struct.g72x_state** %state_ptr.addr, align 8, !tbaa !6
  %call = call i32 (%struct.g72x_state*, ...) bitcast (i32 (...)* @predictor_zero to i32 (%struct.g72x_state*, ...)*)(%struct.g72x_state* %10)
  %conv = trunc i32 %call to i16
  store i16 %conv, i16* %sezi, align 2, !tbaa !8
  %11 = load i16, i16* %sezi, align 2, !tbaa !8
  %conv1 = sext i16 %11 to i32
  %shr = ashr i32 %conv1, 1
  %conv2 = trunc i32 %shr to i16
  store i16 %conv2, i16* %sez, align 2, !tbaa !8
  %12 = load i16, i16* %sezi, align 2, !tbaa !8
  %conv3 = sext i16 %12 to i32
  %13 = load %struct.g72x_state*, %struct.g72x_state** %state_ptr.addr, align 8, !tbaa !6
  %call4 = call i32 (%struct.g72x_state*, ...) bitcast (i32 (...)* @predictor_pole to i32 (%struct.g72x_state*, ...)*)(%struct.g72x_state* %13)
  %add = add nsw i32 %conv3, %call4
  %conv5 = trunc i32 %add to i16
  store i16 %conv5, i16* %sei, align 2, !tbaa !8
  %14 = load i16, i16* %sei, align 2, !tbaa !8
  %conv6 = sext i16 %14 to i32
  %shr7 = ashr i32 %conv6, 1
  %conv8 = trunc i32 %shr7 to i16
  store i16 %conv8, i16* %se, align 2, !tbaa !8
  %15 = load %struct.g72x_state*, %struct.g72x_state** %state_ptr.addr, align 8, !tbaa !6
  %call9 = call i32 (%struct.g72x_state*, ...) bitcast (i32 (...)* @step_size to i32 (%struct.g72x_state*, ...)*)(%struct.g72x_state* %15)
  %conv10 = trunc i32 %call9 to i16
  store i16 %conv10, i16* %y, align 2, !tbaa !8
  %16 = load i32, i32* %i.addr, align 4, !tbaa !2
  %and11 = and i32 %16, 16
  %17 = load i32, i32* %i.addr, align 4, !tbaa !2
  %idxprom = sext i32 %17 to i64
  %arrayidx = getelementptr inbounds [32 x i16], [32 x i16]* @_dqlntab, i32 0, i64 %idxprom
  %18 = load i16, i16* %arrayidx, align 2, !tbaa !8
  %conv12 = sext i16 %18 to i32
  %19 = load i16, i16* %y, align 2, !tbaa !8
  ...
  %20 = load i16, i16* %dq, align 2, !tbaa !8
  %conv16 = sext i16 %20 to i32
  %cmp = icmp slt i32 %conv16, 0
  br i1 %cmp, label %cond.true, label %cond.false

cond.true:                                        ; preds = %entry
  %21 = load i16, i16* %se, align 2, !tbaa !8
  %conv18 = sext i16 %21 to i32
  %22 = load i16, i16* %dq, align 2, !tbaa !8
...
cond.false:                                       ; preds = %entry
  %23 = load i16, i16* %se, align 2, !tbaa !8
  %conv21 = sext i16 %23 to i32
  %24 = load i16, i16* %dq, align 2, !tbaa !8
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %25 = load i16, i16* %sr, align 2, !tbaa !8
  %conv25 = sext i16 %25 to i32
  %26 = load i16, i16* %se, align 2, !tbaa !8
  %conv26 = sext i16 %26 to i32
  %sub27 = sub nsw i32 %conv25, %conv26
  %27 = load i16, i16* %sez, align 2, !tbaa !8
  ...
  %28 = load i16, i16* %y, align 2, !tbaa !8
  %conv31 = sext i16 %28 to i32
  %29 = load i32, i32* %i.addr, align 4, !tbaa !2
  %idxprom32 = sext i32 %29 to i64
  %arrayidx33 = getelementptr inbounds [32 x i16], [32 x i16]* @_witab, i32 0, i64 %idxprom32
  %30 = load i16, i16* %arrayidx33, align 2, !tbaa !8
  %conv34 = sext i16 %30 to i32
  %31 = load i32, i32* %i.addr, align 4, !tbaa !2
  %idxprom35 = sext i32 %31 to i64
  %arrayidx36 = getelementptr inbounds [32 x i16], [32 x i16]* @_fitab, i32 0, i64 %idxprom35
  %32 = load i16, i16* %arrayidx36, align 2, !tbaa !8
  %conv37 = sext i16 %32 to i32
  %33 = load i16, i16* %dq, align 2, !tbaa !8
  %conv38 = sext i16 %33 to i32
  %34 = load i16, i16* %sr, align 2, !tbaa !8
  %conv39 = sext i16 %34 to i32
  %35 = load i16, i16* %dqsez, align 2, !tbaa !8
  %conv40 = sext i16 %35 to i32
  %36 = load %struct.g72x_state*, %struct.g72x_state** %state_ptr.addr, align 8, !tbaa !6
  call void (i32, i32, i32, i32, i32, i32, i32, %struct.g72x_state*, ...) bitcast (void (...)* @update to void (i32, i32, i32, i32, i32, i32, i32, %struct.g72x_state*, ...)*)(i32 5, i32 %conv31, i32 %conv34, i32 %conv37, i32 %conv38, i32 %conv39, i32 %conv40, %struct.g72x_state* %36)
  %37 = load i32, i32* %out_coding.addr, align 4, !tbaa !2
...
sw.bb:                                            ; preds = %cond.end
  %38 = load i16, i16* %sr, align 2, !tbaa !8
  %conv41 = sext i16 %38 to i32
  %39 = load i16, i16* %se, align 2, !tbaa !8
  %conv42 = sext i16 %39 to i32
  %40 = load i16, i16* %y, align 2, !tbaa !8
  %conv43 = sext i16 %40 to i32
  %41 = load i32, i32* %i.addr, align 4, !tbaa !2
  %call44 = call i32 (i32, i32, i32, i32, i32, i16*, ...) bitcast (i32 (...)* @tandem_adjust_alaw to i32 (i32, i32, i32, i32, i32, i16*, ...)*)(i32 %conv41, i32 %conv42, i32 %conv43, i32 %41, i32 16, i16* getelementptr inbounds ([15 x i16], [15 x i16]* @qtab_723_40, i32 0, i32 0))
...
sw.bb.45:                                         ; preds = %cond.end
  ...
  %43 = load i16, i16* %se, align 2, !tbaa !8
  %conv47 = sext i16 %43 to i32
  %44 = load i16, i16* %y, align 2, !tbaa !8
  %conv48 = sext i16 %44 to i32
  %45 = load i32, i32* %i.addr, align 4, !tbaa !2
  %call49 = call i32 (i32, i32, i32, i32, i32, i16*, ...) bitcast (i32 (...)* @tandem_adjust_ulaw to i32 (i32, i32, i32, i32, i32, i16*, ...)*)(i32 %conv46, i32 %conv47, i32 %conv48, i32 %45, i32 16, i16* getelementptr inbounds ([15 x i16], [15 x i16]* @qtab_723_40, i32 0, i32 0))
  store i32 %call49, i32* %retval
  store i32 1, i32* %cleanup.dest.slot
  br label %cleanup

sw.bb.50:                                         ; preds = %cond.end
  %46 = load i16, i16* %sr, align 2, !tbaa !8
...
cleanup:                                          ; preds = %sw.default, %sw.bb.50, %sw.bb.45, %sw.bb
  %47 = bitcast i16* %dqsez to i8*
  call void @llvm.lifetime.end(i64 2, i8* %47) #3
  %48 = bitcast i16* %dq to i8*
  call void @llvm.lifetime.end(i64 2, i8* %48) #3
  %49 = bitcast i16* %sr to i8*
  call void @llvm.lifetime.end(i64 2, i8* %49) #3
  %50 = bitcast i16* %dif to i8*
  call void @llvm.lifetime.end(i64 2, i8* %50) #3
  %51 = bitcast i16* %y to i8*
  call void @llvm.lifetime.end(i64 2, i8* %51) #3
  %52 = bitcast i16* %se to i8*
  call void @llvm.lifetime.end(i64 2, i8* %52) #3
  %53 = bitcast i16* %sez to i8*
  call void @llvm.lifetime.end(i64 2, i8* %53) #3
  %54 = bitcast i16* %sei to i8*
  call void @llvm.lifetime.end(i64 2, i8* %54) #3
  %55 = bitcast i16* %sezi to i8*
  call void @llvm.lifetime.end(i64 2, i8* %55) #3
  %56 = load i32, i32* %retval
  ret i32 %56
}
